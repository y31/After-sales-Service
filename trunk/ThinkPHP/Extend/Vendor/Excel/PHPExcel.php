...
require_once dirname(__FILE__).'/PHPExcel/DocumentProperties.php';

/** PHPExcel_DocumentSecurity */
require_once dirname(__FILE__).'/PHPExcel/DocumentSecurity.php';

/** PHPExcel_Worksheet */
require_once dirname(__FILE__).'/PHPExcel/Worksheet.php';

/** PHPExcel_Shared_ZipStreamWrapper */
require_once dirname(__FILE__).'/PHPExcel/Shared/ZipStreamWrapper.php';
