...
require_once dirname(__FILE__).'/../PHPExcel/Cell/DataValidation.php';

/** PHPExcel_Cell_Hyperlink */
require_once dirname(__FILE__).'/../PHPExcel/Cell/Hyperlink.php';

/** PHPExcel_Worksheet */
require_once dirname(__FILE__).'/../PHPExcel/Worksheet.php';

/** PHPExcel_Calculation */
require_once dirname(__FILE__).'/../PHPExcel/Calculation.php';
