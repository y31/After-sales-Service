...
require_once dirname(__FILE__).'/../../PHPExcel/Shared/Drawing.php';

/** PHPExcel_Shared_String */
require_once dirname(__FILE__).'/../../PHPExcel/Shared/String.php';

/** PHPExcel_HashTable */
require_once dirname(__FILE__).'/../../PHPExcel/HashTable.php';
