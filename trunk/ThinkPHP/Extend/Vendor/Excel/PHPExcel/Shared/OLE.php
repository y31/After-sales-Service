...
require_once dirname(__FILE__).'/../../PHPExcel/Shared/OLE.php'; 
require_once dirname(__FILE__).'/../../PHPExcel/Shared/OLE/OLE_PPS.php';
...
require_once dirname(__FILE__).'/../../PHPExcel/Shared/OLE/ChainedBlockStream.php';
