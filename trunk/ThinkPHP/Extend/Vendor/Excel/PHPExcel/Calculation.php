...
/** PHPExcel_Worksheet */
require_once dirname(__FILE__).'/../PHPExcel/Worksheet.php';
...
/** PHPExcel_NamedRange */
require_once dirname(__FILE__).'/../PHPExcel/NamedRange.php';

/** PHPExcel_Calculation_FormulaParser */
require_once dirname(__FILE__).'/../PHPExcel/Calculation/FormulaParser.php';

/** PHPExcel_Calculation_FormulaToken */
require_once dirname(__FILE__).'/../PHPExcel/Calculation/FormulaToken.php';

/** PHPExcel_Calculation_Functions */
require_once dirname(__FILE__).'/../PHPExcel/Calculation/Functions.php';

/** PHPExcel_Calculation_Function */
require_once dirname(__FILE__).'/../PHPExcel/Calculation/Function.php';
