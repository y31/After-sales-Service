...
require_once dirname(__FILE__).'/../PHPExcel/Style/Color.php';

/** PHPExcel_Style_Font */
require_once dirname(__FILE__).'/../PHPExcel/Style/Font.php';

/** PHPExcel_Style_Fill */
require_once dirname(__FILE__).'/../PHPExcel/Style/Fill.php';

/** PHPExcel_Style_Borders */
require_once dirname(__FILE__).'/../PHPExcel/Style/Borders.php';

/** PHPExcel_Style_Alignment */
require_once dirname(__FILE__).'/../PHPExcel/Style/Alignment.php';

/** PHPExcel_Style_NumberFormat */
require_once dirname(__FILE__).'/../PHPExcel/Style/NumberFormat.php';

/** PHPExcel_Style_Conditional */
require_once dirname(__FILE__).'/../PHPExcel/Style/Conditional.php';

/** PHPExcel_Style_Protection */
require_once dirname(__FILE__).'/../PHPExcel/Style/Protection.php';
