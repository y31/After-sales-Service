...
require_once dirname(__FILE__).'/../PHPExcel/RichText/ITextElement.php';

/** PHPExcel_RichText_TextElement */
require_once dirname(__FILE__).'/../PHPExcel/RichText/TextElement.php';

/** PHPExcel_RichText_Run */
require_once dirname(__FILE__).'/../PHPExcel/RichText/Run.php';
