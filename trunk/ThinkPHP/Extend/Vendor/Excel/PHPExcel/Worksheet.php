...
require_once dirname(__FILE__).'/../PHPExcel/Worksheet/RowDimension.php';

/** PHPExcel_Worksheet_ColumnDimension */
require_once dirname(__FILE__).'/../PHPExcel/Worksheet/ColumnDimension.php';

/** PHPExcel_Worksheet_PageSetup */
require_once dirname(__FILE__).'/../PHPExcel/Worksheet/PageSetup.php';

/** PHPExcel_Worksheet_PageMargins */
require_once dirname(__FILE__).'/../PHPExcel/Worksheet/PageMargins.php';

/** PHPExcel_Worksheet_HeaderFooter */
require_once dirname(__FILE__).'/../PHPExcel/Worksheet/HeaderFooter.php';

/** PHPExcel_Worksheet_BaseDrawing */
require_once dirname(__FILE__).'/../PHPExcel/Worksheet/BaseDrawing.php';

/** PHPExcel_Worksheet_Drawing */
require_once dirname(__FILE__).'/../PHPExcel/Worksheet/Drawing.php';

/** PHPExcel_Worksheet_HeaderFooterDrawing */
require_once dirname(__FILE__).'/../PHPExcel/Worksheet/HeaderFooterDrawing.php';

/** PHPExcel_Worksheet_Protection */
require_once dirname(__FILE__).'/../PHPExcel/Worksheet/Protection.php';

/** PHPExcel_Comment */
require_once dirname(__FILE__).'/../PHPExcel/Comment.php';

/** PHPExcel_Style */
require_once dirname(__FILE__).'/../PHPExcel/Style.php';

/** PHPExcel_Style_Fill */
require_once dirname(__FILE__).'/../PHPExcel/Style/Fill.php';

/** PHPExcel_Style_NumberFormat */
require_once dirname(__FILE__).'/../PHPExcel/Style/NumberFormat.php';

/** PHPExcel_IComparable */
require_once dirname(__FILE__).'/../PHPExcel/IComparable.php';

/** PHPExcel_Shared_Font */
require_once dirname(__FILE__).'/../PHPExcel/Shared/Font.php';

/** PHPExcel_Shared_PasswordHasher */
require_once dirname(__FILE__).'/../PHPExcel/Shared/PasswordHasher.php';

/** PHPExcel_ReferenceHelper */
require_once dirname(__FILE__).'/../PHPExcel/ReferenceHelper.php';
