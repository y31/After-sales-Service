...
function inputText(el) { //extent Text inputs
	...
	el.left = document.createElement('div');//原先是img   现在改为 div
	el.left.src = imagesPath + "0.png";
	el.left.className = "NFTextLeft";
	el.right = document.createElement('div');//原先是img   现在改为 div
...
function textarea(el) { //extend Textareas
	...
	el.init = function() {
		...
		el.left.style.height = (el.height-2) +'px';//不知道为什么左边竖杠比右边少2像素
...
function selectsCopy(el) { //extend Selects
	el.oldClassName = el.className;
	el.dummy = document.createElement('div');
